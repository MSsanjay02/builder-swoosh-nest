      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="space-y-3">
            ...
            <Switch
              ...
              onCheckedChange={(v) => {
                setState({
                  ...state,
                  compression: v,
                  quality: v ? Math.min(state.quality, 80) : 95,
                });
              }}
            />
          </div>
          <Slider
            ...
            max={95}
            step={5}
            onValueChange={(v) => setState({ ...state, quality: v[0] })}
          />
        </div>
      </div>
      ...
      <div className="rounded-xl border p-4 space-y-4">
        <div className="flex items-center justify-between">
          ...
          <Switch
            ...
            onCheckedChange={(v) =>
              setState({
                ...state,
                watermark: { ...state.watermark, enabled: v },
              })
            }
          />
        </div>
        {state.watermark.enabled && (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Select
                ...
                onValueChange={(v) =>
                  setState({
                    ...state,
                    watermark: { ...state.watermark, position: v as any },
                  })
                }
              >
                <SelectTrigger>
            ...
            <div className="space-y-2">
              <Label>
                {t("size")}: {state.watermark.size}px
              </Label>
              <Slider
                ...
                onValueChange={(v) =>
                  setState({
                    ...state,
                    watermark: { ...state.watermark, size: v[0] },
                  })
                }
              />
            </div>
            <div className="space-y-2">
              <Label>
                {t("opacity")}: {state.watermark.opacity}
              </Label>
              <Slider
            ...
            <div className="space-y-2">
              <Label>
                {t("rotation")}: {state.watermark.rotation}°
              </Label>
              <Slider
                ...
                onValueChange={(v) =>
                  setState({
                    ...state,
                    watermark: { ...state.watermark, rotation: v[0] },
                  })
                }
              />
            </div>
